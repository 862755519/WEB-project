export default [{
    ...
    },
    {
        ...
        component: () =>
            import ('@/views/login/register-getCode')
    },
    {
        path: '/login/registerSubmit',
        name: 'registerSubmit',
        component: () =>
            import ('@/views/login/register-submit')
    },
    {
        ...
        props: true,
        component: () =>
            import ('@/views/login/register-status')
    },
    {
        path: '/login/forget',
        name: 'forget',
    ...
    },
    {
        ...
        name: 'forgetReset',
        component: () =>
            import ('@/views/login/forget-reset')
    },
    {
        ...
        props: true,
        component: () =>
            import ('@/views/login/forget-status')
    }
];