<template>
  <div class="item_search">
    <van-nav-bar :fixed="true" title="商品搜索" left-arrow @click-left="onClickLeft">
...
<script>
import { Card, Search, Tag, List, NavBar,Dialog } from 'vant';
...
export default {
  ...
  methods: {
    ...
    itemClick(id) {
      this.$router.push(`/items/detail/${id}`+'?indexBreak=3');
    }
  },
  activated() {
