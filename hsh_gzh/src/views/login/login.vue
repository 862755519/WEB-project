<template>
	<div class="login">
		<van-nav-bar title="登录" :fixed="true" left-arrow @click-left="onClickLeft" >
		...
		<div class="store_header">
			...
			<div class="store_name">华商汇</div>
		</div>
		<md-field-group>
			<md-field v-model="account" icon="username" placeholder="请输入用户名" right-icon="clear-full" name="user"
			 data-vv-as="帐号" @right-click="clearText" />

			<md-field v-model="password" icon="lock" placeholder="请输入密码" :type="visiblePass ? 'text' : 'password'"
			 :right-icon="visiblePass ? 'eye-open' : 'eye-close'" data-vv-as="密码" name="password" @right-click="visiblePass = !visiblePass" />
		...
		<div class="text-desc text-center bottom_positon">技术支持: 方海科技</div>
...
<script>
	...
	import {authLoginByAccount, login_wx } from '@/api/api';
	import {
		setLocalStorage
