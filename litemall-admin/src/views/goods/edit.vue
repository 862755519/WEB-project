  ...
  <div class="app-container">
    ...
    <el-card class="box-card">
      ...
      <el-form ref="goods" :rules="rules" :model="goods" label-width="150px">
        ...
        <!-- <el-form-item label="利润" prop="ofit">
          <el-input v-model="goods.ofit"/>
        </el-form-item>
        <el-form-item label="可获得积分" prop="sellScore">
          <el-input v-model="goods.sellScore"/>
        </el-form-item>
        <el-form-item label="可抵扣积分" prop="sorce">
          <el-input v-model="goods.sorce"/>
        </el-form-item> -->
        <el-form-item label="运费" prop="freight">
          <el-input v-model="goods.freight" placeholder="0.00"/>
        </el-form-item>
        <el-form-item label="服务费" prop="serviceCharge">
          <el-input v-model="goods.serviceCharge" placeholder="0.00"/>
        </el-form-item>
  ...
  data() {
    return {
      ...
      rules: {
        ...
        serviceCharge: [{ required: true, message: '服务费不能为空', trigger: 'blur' }],
